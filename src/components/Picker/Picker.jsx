...
class Picker extends Component {
  ...
  render() {
    ...
    const items = children.map((item) => {
      return (
        <div className={selectedValue === item.value ? `${prefixCls}_item_selected` : `${prefixCls}_item`}
    ...
    return (
      <div className={`${className || ''} ${prefixCls}`} ref={(ref) => { this.component = ref } }>
        <div className={`${prefixCls}_indicator`} ref={(ref) => { this.indicator = ref } }></div>
        <div className={`${prefixCls}_content`} ref={(ref) => { this.content = ref } }>
          {items}
        </div>
      </div>
    )
